...
- `ingold-trailer.html` - the 8'-6" x 20'-0" trailer from the reference sheets: 340 members, 432 joints, five connected systems, built by the operative loop and replayed move by move.
...
- `tests/run.mjs` - `node tests/run.mjs` runs 228 assertions against the world model and the built trailer.
